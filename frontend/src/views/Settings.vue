    ...
    <section class="settings-shell">
      ...
      <div class="settings-content">
        ...
        <section v-if="activeSection === 'general'" class="settings-section">
          <div class="panel-head"><h3>常规设置</h3><p>记忆开关与项目信息</p></div>
          <div class="settings-group">
            ...
            <div class="setting-row">
              <div class="setting-info">
                <label>评测工作台</label>
                <p class="desc">集中管理评估集并查看检索、分块和生成指标。</p>
              </div>
              <div class="setting-control">
                <button class="btn btn-sm btn-outline" type="button" @click="router.push('/platform/evaluation')">打开</button>
              </div>
            </div>
